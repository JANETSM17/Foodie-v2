...
router.get('/enviarPedido/:id/:espera/:especificaciones/:pickup',async (req,res) => {
    ...
    console.log(date)
    const resultado = await db.query("update","pedidos",{_id:db.objectID(id)},{$set:{estado:"Esperando confirmacion",entrega:date,especificaciones:especificaciones,pickup:pickup,clave:clave}})
