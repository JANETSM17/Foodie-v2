...
router.post('/', async (req, res) => {
    ...
    if(contraseña==password){
        ...
        if(proveedores.length > 0 || clientes.length > 0){//revisa que no este tratando de crear una cuenta con un correo o telefono ya utilizadp
            ...
            const queryObject = {nombre: nombre, correo: correo, contraseña: contraseña, telefono: telefono,rfc:rfc, created_at: new Date(),imagen: 'https://res.cloudinary.com/foodiecloudinary/image/upload/v1722137836/estrella_ixt70l.png',active: true, "regimen fiscal": regimen, direccion: direccion, calif: 0, min_espera:15,clave:clave};//crea un objeto con la info del usuario
